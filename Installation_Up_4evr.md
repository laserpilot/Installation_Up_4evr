...
Another useful tool for modifying certain OSX .plists for disable or enabling certain things is [Tinkertool][7] You can use this to disable or enable certain things that System Preferences doesn't cover. 
...
Here is an [Apple Doc][9] on using Launch Agents and Launch Daemons in various ways.

The [difference between a Launch Daemon and a Launch Agent][10] (Basically whether you need it to run when a user is logged in or not…for most simple options like launching a regular app, you’ll just want a Launch Agent)
...
(I got the following super helpful tip from [Kyle McDonald][14])
...
> \#!/bin/sh if [ $(ps ax | grep -v grep | grep "Twitter.app" | wc -l) -eq 0 ] then
...
(more info above ps commands [here][23]) – Further more you can filter this list to only return applications you’re interested in learning about:
...
See [this article][24] about combining the above process with something that kills and restarts an app if it crosses a memory usage threshold
...
Check out this great step by step from EVSC: http://www.evsc.net/home/prep-windows-machine-for-fulltime-exhibition-setup
  ...
  [1]: http://blairneal.com/blog/installation-up-4evr/
  [2]: http://www.bombich.com/
  [3]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/Bluetooth_settings.png
  [4]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/Security_settings.png
  [5]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/Sharing_settings.png
  [6]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/Auto_login.png
  [7]: http://www.bresink.com/osx/TinkerTool.html
  [8]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/Login_items.png
  [9]: http://developer.apple.com/library/mac/#documentation/MacOSX/Conceptual/BPSystemStartup/Chapters/CreatingLaunchdJobs.html
  [10]: http://techjournal.318.com/general-technology/launchdaemons-vs-launchagents/
  [11]: http://www.peterborgapps.com/lingon/
  [12]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/LingonSetup.png
  [13]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/LingonSetup2.png
  [14]: http://kylemcdonald.net/
  [15]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/Cronnix-settings.png
  [16]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/Auto_reboot.png
  [17]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/Automator_example2.png
  [18]: https://raw.github.com/laserpilot/Installation_Up_4evr/master/Images/Automator_example.png
  [19]: http://www.logmein.com/
  [20]: http://teamviewer.com/
  [21]: http://realvnc.com/
  [22]: http://www.mactricksandtips.com/2009/06/ssh-into-your-mac.html
  [23]: https://developer.apple.com/library/mac/documentation/Darwin/Reference/ManPages/man1/ps.1.html

...
class DataTransformer {
  ...
  static sanitizeMetric(metric) {
    ...
    if (metric.availableGB !== undefined)
      sanitized.availableGB = metric.availableGB;
    if (metric.volumes) sanitized.volumes = metric.volumes;
    if (metric.storageBreakdown)
      sanitized.storageBreakdown = metric.storageBreakdown;
    if (metric.mainVolume !== undefined)
      sanitized.mainVolume = metric.mainVolume;
